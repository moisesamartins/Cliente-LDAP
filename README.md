# LDAPS Client Configuration
# Joining Ubuntu Server to the Windows domain and configuring the LDAP client with SSSD-AD to authenticate Active Directory users.
